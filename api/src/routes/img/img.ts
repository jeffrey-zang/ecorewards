...
router.post('/img', async (req: Request, res: Response) => {
  try {
    ...
    // points = 5% of the total cost where 100 points = $1
    jsonResponse['points'] = Math.round(jsonResponse.totalCost * 100 * 0.05);
